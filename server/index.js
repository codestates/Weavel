...
schedule.scheduleJob("0 45 3 * * *", () => {
  axios.get("https://server.weavel.site/weatherAPI?id=10");
});
schedule.scheduleJob("0 55 3 * * *", () => {
...
schedule.scheduleJob("0 20 4 * * *", () => {
  axios.get("https://server.weavel.site/weatherAPI?id=116");
});
schedule.scheduleJob("0 25 4 * * *", () => {
